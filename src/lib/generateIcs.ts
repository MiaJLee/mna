...
export function generateIcs(datetime: string, venueName: string, address: string): void {
...
export function getGoogleCalendarUrl(datetime: string, venueName: string, address: string): string {
	const dt = parseWeddingDate(datetime)
	const endDt = dt.plus({ hours: 2 })
